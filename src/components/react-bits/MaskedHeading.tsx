...
import React, { useCallback, useEffect, useId, useMemo, useRef, ElementType, CSSProperties } from 'react';
...
const MaskedHeading: React.FC<MaskedHeadingProps> = ({
  ...
  const sync = useCallback(() => {
    ...
    root.style.fontSize = `${clamp(root.clientWidth * s.textScale, 24, 200).toFixed(1)}px`;
