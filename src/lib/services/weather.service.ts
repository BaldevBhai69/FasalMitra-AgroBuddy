    ...
    try {
      ...
      return {
        ...
        current: {
          ...
          humidityPct: Math.round(today.humidityMeanPct || 65),
          precipitationMm: Number((today.precipitationMm || 0).toFixed(1)),
          windSpeedKmh: Number((today.windSpeedMaxKmh || 12).toFixed(1)),
          weatherCode: today.weatherCode,
          soilMoisturePct: today.soilMoisture0To7cm ? Number((today.soilMoisture0To7cm * 100).toFixed(1)) : 45.0,
          soilTemperatureC: Number((today.soilTemperature0To7cm || 24.5).toFixed(1)),
        },
        daily,
        source: 'cache',
